                ...
                <div class="hero-1 featured-slider-1-items mb-65">
                    <div class="slider-single">
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <div class="post-meta-2 font-md d-flext align-self-center mb-md-30">
                                    <a href="page-author.html">
                                        <img src="{{ asset('imgs/authors/author.jpg') }}" alt="">
                            ...
                            <div class="col-lg-6">
                                <img class="border-radius-10" src="{{ asset('imgs/news/thumb-10.jpg') }}" alt="flow">
                            </div>
                        </div>
                    </div>
                    <div class="slider-single">
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <div class="post-meta-2 font-md d-flext align-self-center mb-md-30">
                                    <a href="page-author.html">
                                        <img src="{{ asset('imgs/authors/author-3.jpg') }}" alt="">
                            ...
                            <div class="col-lg-6">
                                <img class="border-radius-10" src="{{ asset('imgs/news/thumb-11.jpg') }}" alt="flow">
                            </div>
                        </div>
                    </div>
                    <div class="slider-single">
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <div class="post-meta-2 font-md d-flext align-self-center mb-md-30">
                                    <a href="page-author.html">
                                        <img src="{{ asset('imgs/authors/author-4.jpg') }}" alt="">
                            ...
                            <div class="col-lg-6">
                                <img class="border-radius-10" src="{{ asset('imgs/news/thumb-12.jpg') }}" alt="flow">
                            </div>
                        </div>
                    </div>
                    <div class="slider-single">
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <div class="post-meta-2 font-md d-flext align-self-center mb-md-30">
                                    <a href="page-author.html">
                                        <img src="{{ asset('imgs/authors/author-2.jpg') }}" alt="">
                            ...
                            <div class="col-lg-6">
                                <img class="border-radius-10" src="{{ asset('imgs/news/thumb-13.jpg') }}" alt="flow">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="featured-slider-1-nav row">
                <div class="col d-flex transition-normal latest-small-thumb">
                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                        <a class="color-white" href="single.html">
                            <img src="{{ asset('imgs/news/thumb-10.jpg') }}" alt="">
                        </a>
                    </div>
                ...
                <div class="col d-flex transition-normal latest-small-thumb">
                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                        <a class="color-white" href="single.html">
                            <img src="{{ asset('imgs/news/thumb-11.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-content media-body align-self-center">
                        <h5 class="post-title mb-15 text-limit-2-row font-medium">
                ...
                <div class="col d-flex transition-normal latest-small-thumb">
                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                        <a class="color-white" href="single.html">
                            <img src="{{ asset('imgs/news/thumb-12.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-content media-body align-self-center">
                        <h5 class="post-title mb-15 text-limit-2-row font-medium">
                ...
                <div class="col d-flex transition-normal latest-small-thumb">
                    <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                        <a class="color-white" href="single.html">
                            <img src="{{ asset('imgs/news/thumb-13.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-content media-body align-self-center">
                        <h5 class="post-title mb-15 text-limit-2-row font-medium">
                ...
                <div class="slide-fade slide-fade-inner bg-brand-4 border-radius-10 p-65 p-sm-25">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <figure class="position-relative">
                                    <img class="border-radius-10 post-thumb" src="{{ asset('imgs/news/news-17.jpg') }}" alt="flow">
                                </figure>
                            </div>
                        </div>
                    </div>
                    <div class="slide-fade-item">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <figure class="position-relative">
                                    <img class="border-radius-10 post-thumb" src="{{ asset('imgs/news/news-18.jpg') }}" alt="flow">
                                </figure>
                            </div>
                        </div>
                    </div>
                    <div class="slide-fade-item">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <figure class="position-relative">
                                    <img class="border-radius-10 post-thumb" src="{{ asset('imgs/news/news-19.jpg') }}" alt="flow">
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <article class="col-lg-6 col-md-6 mb-30 wow fadeIn animated">
                    <div class="post-card-1 large border-radius-10 hover-up">
                        <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url({{ asset('imgs/news/news-8.jpg')}})">
                            <a class="img-link" href="single.html"></a>
                            <div class="post-meta-1 mb-20">
                ...
                <article class="col-lg-6 col-md-6 mb-30 wow fadeIn animated">
                    <div class="post-card-1 large border-radius-10 hover-up">
                        <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url({{ asset('imgs/news/news-5.jpg') }})">
                            <a class="img-link" href="single.html"></a>
                            <div class="post-meta-1 mb-20">
                ...
                <article class="col-lg-6 col-md-6 mb-0 wow fadeIn animated">
                    <div class="post-card-1 large border-radius-10 hover-up">
                        <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url({{ asset('imgs/news/news-6.jpg') }})">
                            <a class="img-link" href="single.html"></a>
                            <div class="post-meta-1 mb-20">
                ...
                <article class="col-lg-6 col-md-6 mb-0 wow fadeIn animated">
                    <div class="post-card-1 large border-radius-10 hover-up">
                        <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url({{ asset('imgs/news/news-7.jpg') }})">
                            <a class="img-link" href="single.html"></a>
                            <div class="post-meta-1 mb-20">
