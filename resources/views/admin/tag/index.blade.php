                            ...
                            <table class="table" role="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        <td>{{ $tag->id }}</td>
                                        <td>{{ $tag->title }}</td>
                                        <td><a class="text-primary" href="{{ route('admin.tag.show', $tag->id) }}"><i class="nav-icon bi bi-eye"></i></a></td>
                                        <td><a class="text-success" href="{{ route('admin.tag.edit', $tag->id) }}"><i class="nav-icon bi bi-pen"></i></a></td>
                                        <td>
