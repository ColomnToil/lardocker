...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('imgs/theme/favicon.png') }}">
    <!-- Template CSS  -->
...
<body class="home-page-1">
    ...
    <aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar">
        <button class="off-canvas-close"><img class="svg-icon-24" src="{{ asset('imgs/theme/svg/close.svg') }}" alt=""></button>
        ...
        <div class="position-relative">
            <div class="container align-self-center">
                <div class="header-style-1">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('imgs/theme/logo.svg') }}" alt=""></a>
                    </div>
                    ...
                    <div class="header-right">
                        <button class="search-icon d-md-inline">
                            <img src="{{ asset('imgs/theme/svg/search.svg') }}" alt="">
                        </button>
            ...
            <div class="off-canvas-toggle-cover d-inline-block">
                <div class="off-canvas-toggle hidden d-inline-block" id="off-canvas-toggle">
                    <img class="svg-icon-24" src="{{ asset('imgs/theme/svg/menu.svg') }}" alt="">
                </div>
            </div>
        </div>
    </header>
                            ...
                            <div class="input-group w-100">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-search bg-white" type="submit">
                                        <img class="svg-icon-24" src="{{ asset('imgs/theme/svg/search.svg') }}" alt="">
                                    </button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="row mb-65">
                <div class="col-md-6">
                    <div class="logo wow fadeIn animated">
                        <a href="index.html"> <img src="{{ asset('imgs/theme/logo-white.svg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <script src="{{ asset('js/vendor/jquery.scrollUp.min.js') }}"></script>
    <script src="{{ asset('js/vendor/jquery.theia.sticky.js') }}"></script>
    <!-- Template  JS -->
